...
var  Q=createMultiDimArray('100'),Ans=createMultiDimArray('100,5'),Qnum,Lnum,DoneQ=createMultiDimArray('100'),MaxQ=createMultiDimArray('3'),MyAns,Skip_Option,Fifty_Option,Croud_Option;
Fifty_Option = False;
Croud_Option = False;
Skip_Option = False;
Lnum = 1;
